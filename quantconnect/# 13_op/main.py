...
class LogicalSkyBlueDog(QCAlgorithm):
    ...
    def MA_ATR_RSI_WARMUP(self, sender, bar):
        ...
        if len(self.rsi_2_queue) == 3 and len(self.Long_Band_Queue_2) == 3 and self.New_Long_Band_2 is not None:
            if self.rsi_2_queue[1] > self.Long_Band_Queue_2[1] and self.rsi_ema.Current.Value > self.Long_Band_Queue_2[
                1]:
        ...
        if len(self.rsi_2_queue) == 3 and len(self.Short_Band_Queue_2) == 3 and self.New_Short_Band_2 is not None:
            if self.rsi_2_queue[1] < self.Short_Band_Queue_2[1] and self.rsi_ema.Current.Value < \
                    self.Short_Band_Queue_2[1]:
        ...
        if len(self.Long_Band_Queue_2) == 3 and len(self.rsi_2_queue) == 2:
            if self.Long_Band_Queue_2[1] > self.rsi_ema.Current.Value and self.Long_Band_Queue_2[2] < self.rsi_2_queue[
                1]:
                self.cross_2 = True
            elif self.Long_Band_Queue_2[1] < self.rsi_ema.Current.Value and self.Long_Band_Queue_2[2] > \
                    self.rsi_2_queue[1]:
                self.cross_2 = True
            else:
                self.cross_2 = False
        ...
        if len(self.Short_Band_Queue_2) == 3 and len(self.rsi_2_queue) == 2:
            if self.Short_Band_Queue_2[1] > self.rsi_ema.Current.Value and self.Short_Band_Queue_2[2] < \
                    self.rsi_2_queue[1]:
                check_2 = True
            elif self.Short_Band_Queue_2[1] < self.rsi_ema.Current.Value and self.Short_Band_Queue_2[2] > \
                    self.rsi_2_queue[1]:
                check_2 = True
            else:
                check_2 = False
        ...
        if len(self.Long_Band_Queue) == 3 and len(self.rsi_sma_queue) == 2:
            if self.Long_Band_Queue[1] > self.rsi_sma.Current.Value and self.Long_Band_Queue[2] < self.rsi_sma_queue[1]:
                self.cross_1 = True
            elif self.Long_Band_Queue[1] < self.rsi_sma.Current.Value and self.Long_Band_Queue[2] > self.rsi_sma_queue[
                1]:
                self.cross_1 = True
            else:
                self.cross_1 = False
        ...
        if len(self.Short_Band_Queue) == 3 and len(self.rsi_sma_queue) == 2:
            if self.Short_Band_Queue[1] > self.rsi_sma.Current.Value and self.Short_Band_Queue[2] < self.rsi_sma_queue[
                1]:
                check = True
            elif self.Short_Band_Queue[1] < self.rsi_sma.Current.Value and self.Short_Band_Queue[2] > \
                    self.rsi_sma_queue[1]:
                check = True
            else:
                check = False
    ...
    def IndicatorUpdate(self, bar):
        ...
        if not self.Warming_Up:
            ...
            if self.SMMA_Fastest is not None:
                ...
                self.SMMA_Fastest = (self.SMMA_Fastest * (
                            self.SMMA_Fastest_Length - 1) + src_fastest) / self.SMMA_Fastest_Length
            ...
            if len(self.rsi_2_queue) == 3 and len(self.Long_Band_Queue_2) == 3 and self.New_Long_Band_2 is not None:
                if self.rsi_2_queue[1] > self.Long_Band_Queue_2[1] and self.rsi_ema.Current.Value > \
                        self.Long_Band_Queue_2[1]:
                    self.Long_Band_2 = max(self.Long_Band_Queue_2[1], self.New_Long_Band_2)
                else:
                    self.Long_Band_2 = self.New_Long_Band_2
            ...
            if len(self.Long_Band_Queue_2) == 3 and len(self.rsi_2_queue) == 2:
                if self.Long_Band_Queue_2[1] > self.rsi_ema.Current.Value and self.Long_Band_Queue_2[2] < \
                        self.rsi_2_queue[1]:
                    self.cross_2 = True
                elif self.Long_Band_Queue_2[1] < self.rsi_ema.Current.Value and self.Long_Band_Queue_2[2] > \
                        self.rsi_2_queue[1]:
            ...
            if self.dar_ema.IsReady:
                ...
                if len(self.rsi_sma_queue) == 3 and len(self.Long_Band_Queue) == 3 and self.New_Long_Band is not None:
                    ...
                    if self.rsi_sma_queue[1] > self.Long_Band_Queue[1] and self.rsi_sma_queue[0] > self.Long_Band_Queue[
                        1]:
                        self.Long_Band = max(self.Long_Band_Queue[1], self.New_Long_Band)
                    else:
                        self.Long_Band = self.New_Long_Band
                ...
                if len(self.rsi_sma_queue) == 3 and len(self.Short_Band_Queue) == 3 and self.New_Short_Band is not None:
                    ...
                    if self.rsi_sma_queue[1] < self.Short_Band_Queue[1] and self.rsi_sma_queue[0] < \
                            self.Short_Band_Queue[1]:
                        self.Short_Band = min(self.Short_Band_Queue[1], self.New_Short_Band)
                    else:
                        self.Short_Band = self.New_Short_Band
                ...
                if self.Long_Band_Queue[1] > self.rsi_sma.Current.Value and self.Long_Band_Queue[2] < \
                        self.rsi_sma_queue[1]:
                    self.cross_1 = True
                elif self.Long_Band_Queue[1] < self.rsi_sma.Current.Value and self.Long_Band_Queue[2] > \
                        self.rsi_sma_queue[1]:
                    self.cross_1 = True
                else:
                    self.cross_1 = False
                ...
                if self.Short_Band_Queue[1] > self.rsi_sma.Current.Value and self.Short_Band_Queue[2] < \
                        self.rsi_sma_queue[1]:
                    check = True
                elif self.Short_Band_Queue[1] < self.rsi_sma.Current.Value and self.Short_Band_Queue[2] > \
                        self.rsi_sma_queue[1]:
    ...
    def display_params(self):
        self.Debug("tdi_rsi=" + str(int(om.tdi_rsi)))
        self.Debug("slow_ma_on_rsi=" + str(int(om.slow_ma_on_rsi)))
        self.Debug("fast_ma_on_rsi=" + str(int(om.fast_ma_on_rsi)))
        self.Debug("smma_slow_length=" + str(int(om.smma_slow_length)))
        self.Debug("smma_fast_length=" + str(int(om.smma_fast_length)))
        self.Debug("smma_fastest_length=" + str(int(om.smma_fastest_length)))
        self.Debug("signal_offset=" + str(float(om.signal_offset)))
        self.Debug("signal_sigma=" + str(int(om.signal_sigma)))
        self.Debug("band_length=" + str(int(om.band_length)))
        self.Debug("candle_size_factor=" + str(float(om.candle_size_factor)))
        self.Debug("donchain_period=" + str(int(om.donchain_period)))
        self.Debug("ema_period=" + str(int(om.ema_period)))
        self.Debug("fast_offset=" + str(float(om.fast_offset)))
        self.Debug("fast_sigma=" + str(int(om.fast_sigma)))
        self.Debug("long_alma_length=" + str(int(om.long_alma_length)))
        self.Debug("short_alma_length=" + str(int(om.short_alma_length)))
        self.Debug("tema_period=" + str(int(om.tema_period)))
        self.Debug("trend_offset=" + str(float(om.trend_offset)))
        self.Debug("trend_sigma=" + str(int(om.trend_sigma)))
        self.Debug("volatility_period=" + str(int(om.volatility_period)))
        self.Debug("volume_ma_length=" + str(int(om.volume_ma_length)))
